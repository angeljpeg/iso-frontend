...
export function SeguimientoDetailsModal({
  seguimiento,
  onClose,
}: SeguimientoDetailsModalProps) {
  ...
  const handleExportPDF = async () => {
    try {
      ...
      // doc.text(`Asignatura: ${seguimiento.cargaAcademica.asignatura}`, 20, 50);
      // doc.text(`Clave: ${seguimiento.cargaAcademica.asignatura}`, 20, 60);
      // doc.text(`Cuatrimestre: ${seguimiento.cuatrimestre.nombreGenerado}`, 20, 70);
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900">
                    Revisión #{seguimiento.numeroRevision}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="text-center p-3 bg-gray-50 rounded-lg">
                ...
                <p className="text-sm text-gray-900">
                  {seguimiento.fechaEntregado
                    ? new Date(seguimiento.fechaEntregado).toLocaleDateString(
                        "es-ES"
                      )
                    : "Pendiente"}
                </p>
