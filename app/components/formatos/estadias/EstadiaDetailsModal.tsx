...
export function EstadiaDetailsModal({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Detalles de la Estadía">
      <div className="space-y-6">
        ...
        <Card className="p-4">
          <h3 className="text-lg font-medium text-gray-900 mb-4">
            Alumnos ({estadia.alumnos.length})
          </h3>
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-600">
                      {alumno.progresoMensual.length} evaluaciones mensuales
                    </span>
                  </div>
                </div>
                ...
                {/* Progreso mensual */}
                {alumno.progresoMensual.length > 0 && (
                  <div className="mt-3 pt-3 border-t border-gray-100">
                    <h5 className="text-sm font-medium text-gray-700 mb-2">
                      Progreso Mensual:
                    </h5>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                      {alumno.progresoMensual.map((progreso) => (
                        <div
                          key={progreso.id}
                          className="text-xs p-2 border rounded"
                        >
                          <div className="font-medium">Mes {progreso.mes}</div>
