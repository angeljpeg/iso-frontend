...
import { ChevronRightIcon, BookOpenIcon, CalendarIcon, GraduationCapIcon } from "lucide-react";
    ...
    >
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Badge variant="secondary" className="text-xs font-medium bg-green-100 text-green-700 hover:bg-green-200">
